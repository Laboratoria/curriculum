...
posibilidades, hasta donde logres llegar. **No esperamos que todas completen todos 3 hitos**.
...
* Agregar una cuenta regresiva con un tiempo límite para responder cada pregunta. Para lograrlo, les dejamos [una pista de javascript](https://es.javascript.info/settimeout-setinterval).
* [Subir tu código a GitHub](https://developer.mozilla.org/es/docs/Learn/Common_questions/Using_Github_pages) (commit/push) y desplegar la interfaz usando [GitHub
