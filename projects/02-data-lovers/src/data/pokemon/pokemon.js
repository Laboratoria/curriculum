export default {
  pokemon: [
    ...
    },
    {
      ...
      resistant: ['fire', 'grass', 'fighting', 'bug', 'steel'],
    ...
    },
    {
      ...
      about:
        'This Pokémon has a dazzling plumage of beautifullyglossy feathers. Many Trainers are captivated by thestriking beauty of the feathers on its head, compellingthem to choose Pidgeot as their Pokémon.',
    ...
    },
    {
      ...
      resistant: ['electric', 'fighting', 'poison', 'bug', 'rock'],
    ...
    },
    {
      ...
      resistant: ['fire', 'water', 'ice', 'bug', 'rock'],
    ...
    },
    {
      ...
      resistant: ['fire', 'water', 'ice', 'fighting', 'poison'],
    ...
    },
    {
      ...
      resistant: ['normal', 'fire', 'electric', 'poison', 'flying'],
    ...
    },
    {
      ...
      resistant: ['fire', 'water', 'ice', 'fighting', 'psychic'],
    ...
    },
    {
      ...
      resistant: ['normal', 'electric', 'grass', 'ice', 'poison'],
    ...
    },
    {
      ...
      encounter: {
        ...
        'base-capture-rate': '0.3',
        'common-capture-area':
          'early reports that this pokémon is likely to be found in: asia or hatched from an egg in that geographic area.',
      },
      'spawn-chance': '0.0212',
      stats: {
        'base-attack': '124',
    ...
    },
    {
      ...
      resistant: ['normal', 'grass', 'fighting', 'poison', 'bug'],
    ...
    },
    {
      ...
      about:
        'Voltorb was first sighted at a company that manufactures PokÃ© Balls. The link between that sighting and the fact that this Pokémon looks very similar to a PokÃ© Ball remains a mystery.',
    ...
    },
    {
      ...
      encounter: {
        ...
        'base-capture-rate': '0.2',
        'common-capture-area':
          'early reports that this pokémon is likely to be found in: australia, new zealand or hatched from an egg in that geographic area.',
      },
      'spawn-chance': '0.0086',
      stats: {
        'base-attack': '181',
    ...
    },
    {
      ...
      encounter: {
        ...
        'base-capture-rate': '0.3',
        'common-capture-area':
          'early reports that this pokémon is likely to be found in: western europe or hatched from an egg in that geographic area.',
      },
      'spawn-chance': '0.0031',
      stats: {
        'base-attack': '192',
    ...
    },
    {
      ...
      encounter: {
        ...
        'base-capture-rate': '0.3',
        'common-capture-area':
          'early reports that this pokémon is likely to be found in: north america or hatched from an egg in that geographic area.',
      },
      'spawn-chance': '0.12',
      stats: {
        'base-attack': '198',
    ...
    },
    {
      ...
      resistant: ['fire', 'water', 'fighting', 'ground', 'bug'],
      weaknesses: ['electric', 'rock'],
      'quick-move': [
        {
          name: 'bite',
    ...
    },
    {
      ...
      resistant: ['grass', 'fighting', 'ground', 'bug'],
      weaknesses: ['fire', 'electric', 'ice', 'flying'],
      'quick-move': [
        {
          name: 'tackle',
          type: 'normal',
    ...
    },
    {
      ...
      resistant: ['fire', 'water', 'ice', 'flying', 'steel'],
    ...
    },
    {
      ...
      weaknesses: ['electric', 'ice', 'rock', 'ghost'],
      'quick-move': [
        {
          name: 'peck',
          type: 'flying',
    ...
    },
    {
      ...
      resistant: ['water', 'grass', 'fighting', 'ground'],
      weaknesses: ['fire', 'ice', 'poison', 'flying'],
      'quick-move': [
        {
          name: 'tackle',
    ...
    },
    {
      ...
      resistant: ['fire', 'poison', 'rock', 'steel'],
      weaknesses: ['grass'],
      'quick-move': [
        {
          name: 'water gun',
    ...
    },
    {
      ...
      resistant: ['grass', 'ground', 'psychic', 'ghost', 'dark'],
    ...
    },
    {
      ...
      resistant: ['fire', 'water', 'ice', 'fighting', 'psychic'],
      weaknesses: ['electric', 'grass', 'bug', 'ghost'],
      'quick-move': [
        {
          name: 'water gun',
          type: 'water',
    ...
    },
    {
      ...
      resistant: ['fighting', 'poison', 'ground', 'bug'],
    ...
    },
    {
      ...
      resistant: ['normal', 'electric', 'poison', 'flying', 'psychic'],
    ...
    },
    {
      ...
      resistant: ['ice', 'psychic', 'ghost', 'dark'],
      weaknesses: ['fire', 'fighting', 'bug', 'rock'],
      'quick-move': [
        {
          name: 'ice shard',
          type: 'ice',
    ...
    },
    {
      ...
      resistant: ['normal', 'grass', 'poison', 'flying', 'psychic'],
    ...
    },
    {
      ...
      resistant: ['ice', 'psychic'],
      weaknesses: ['fire', 'bug', 'rock', 'ghost'],
      'quick-move': [
        {
          name: 'powder snow',
          type: 'ice',
