...
test.describe('Para un texto con sólo palábras:', () => {
  ...
  test('Caracteres: 123', async ({ page }) => {
    await expect(
      page.locator('li[data-testid="character-count"]:has-text("123")'),
    ).toBeVisible();
  });
  ...
  test('Caracteres Sin Espacios: 102', async ({ page }) => {
    await expect(
      page.locator(
        'li[data-testid="character-no-spaces-count"]:has-text("102")',
      ),
    ).toBeVisible();
  });
  ...
  test('Palabras: 19', async ({ page }) => {
    await expect(
      page.locator('li[data-testid="word-count"]:has-text("19")'),
    ).toBeVisible();
  });

  test('Números: 0', async ({ page }) => {
    await expect(
      page.locator('li[data-testid="number-count"]:has-text("0")'),
    ).toBeVisible();
  });

  test('Suma números: 0', async ({ page }) => {
    await expect(
      page.locator('li[data-testid="number-sum"]:has-text("0")'),
    ).toBeVisible();
  });

  test('Longitud promedio palabra: 5.53', async ({ page }) => {
    await expect(
      page.locator('li[data-testid="word-length-average"]:has-text("5.53")'),
    ).toBeVisible();
  });
});
...
test.describe('Para un texto con números:', () => {
  ...
  test('Números: 2', async ({ page }) => {
    await expect(
      page.locator('li[data-testid="number-count"]:has-text("2")'),
    ).toBeVisible();
  });

  test('Suma números: 10', async ({ page }) => {
    await expect(
      page.locator('li[data-testid="number-sum"]:has-text("10")'),
    ).toBeVisible();
  });
});
...
test.describe('Para un texto números decimales:', () => {
  ...
  test('Números: 3', async ({ page }) => {
    await expect(
      page.locator('li[data-testid="number-count"]:has-text("3")'),
    ).toBeVisible();
  });

  test('Suma números: 2.9', async ({ page }) => {
    await expect(
      page.locator('li[data-testid="number-sum"]:has-text("2.9")'),
    ).toBeVisible();
  });
});
...
test.skip('Opcional:', () => {
  ...
  test.describe('Para un texto con sólo signos de puntuación:', () => {
    ...
    test('Caracteres: 18', async ({ page }) => {
      await expect(
        page.locator('li[data-testid="character-count"]:has-text("18")'),
      ).toBeVisible();
    });
    ...
    test('Caracteres Sin Espacios: 0', async ({ page }) => {
      await expect(
        page.locator(
          'li[data-testid="character-no-spaces-count"]:has-text("0")',
        ),
      ).toBeVisible();
    });
    ...
    test('Palabras: 0', async ({ page }) => {
      await expect(
        page.locator('li[data-testid="word-count"]:has-text("0")'),
      ).toBeVisible();
    });
    ...
    test('Longitud promedio palabra: 0', async ({ page }) => {
      await expect(
        page.locator('li[data-testid="word-length-average"]:has-text("0")'),
      ).toBeVisible();
    });
  });
  ...
  test.describe('Para un texto vacio:', () => {
    ...
    test('Caracteres: 0', async ({ page }) => {
      await expect(
        page.locator('li[data-testid="character-count"]:has-text("0")'),
      ).toBeVisible();
    });
  ...
  test.describe('Para un texto de solo espacios:', () => {
    ...
    test('Caracteres: 7', async ({ page }) => {
      await expect(
        page.locator('li[data-testid="character-count"]:has-text("7")'),
      ).toBeVisible();
    });
