...
* [ ] Inclui informações para desenvolvedores (deps, instalação, uso, 
implantação, teste, ...)
...
* [ ] Você pode _adicionar a tela inicial_ como um aplicativo da web
(ele tem um manifesto, ícones, ...) em iOS e Android.
