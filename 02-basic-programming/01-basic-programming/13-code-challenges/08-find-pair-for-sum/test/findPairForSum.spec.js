...
describe("findPairForSum()", function () {
  it("debería regresar [0, 1], para ([0, 8, 1, 7, 19, 12, 4], 1)", function () {
  ...
  it("debería regresar [2, 11], para  ([1, 2, 6, 8, 11, 10], 13)", function () {
  ...
  it("debería regresar [4, 5], para ([3, 34, 4, 12, 5, 2], 9)", function () {
