...
describe("greetCustomer()", function () {
  it("debería regresar 'Welcome back, Howard! So glad to see you again!', para  ('Howard')", function () {
  ...
  it("debería regresar'Welcome back, Joe! We're glad you liked us the first time!', para ('Joe')", function () {
  ...
  it("debería regresar  'Welcome! Is this your first time?', para  ('Kemal')", function () {
