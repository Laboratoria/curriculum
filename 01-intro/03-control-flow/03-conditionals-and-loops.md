...
El texto a continuación se basa en gran medida, con ciertos ajustes en :
...
-  Capítulo 6 de [JavaScript for kids](http://pepa.holla.cz/wp-content/uploads/2015/11/JavaScript-for-Kids.pdf), Nick Morgan, 2015.

***

## Control de Flujo
La razón por la cual creamos programas de computación es para **resolver problemas con ayuda de las computadoras**. Un programa, como hemos visto, es simplemente un conjunto de "instrucciones" que las computadoras siguen. Ese conjunto de instrucciones resuelven un problema. La manera en la cual el computador sigue dichas instrucciones se conoce como **el flujo de un programa**.

Hasta ahora hemos aprendido a obtener, representar, manipular y almacenar data en `variables`. Con esto, hemos podido crear programas que resuelven problemas muy sencillos. Esto es el caso, por ejemplo, del programa que hicimos para transformar la temperatura en Celsius (°C) a Farenheit (°F). Sin embargo, para crear programas más complejos, es necesario expandir nuestro conocimiento sobre cómo **controlar** el flujo de un programa. Esto lo hacemos a través de __estructuras de control de flujo__.
...
Otra forma de modificar el flujo de un programa es a través de estructuras repetitivas, también llamados bucles ("loops" en inglés). Hasta el momento hemos visto, que los condicionales permiten ejecutar un conjunto de sentencias una vez si una condición o sentencia _**es**_ verdadera. Los bucles, por su lado, permiten ejecutar un código varias veces, dependiendo de si una condición _**sigue siendo**_ verdadera.
...
Hacer que la condición del bucle produzca _false_ no es la única forma de que un bucle termine. Podemos usar la sentencia especial `break`, utilizada en `switch`, que tiene el efecto de salir inmediatamente del bucle que la esté encerrando.
