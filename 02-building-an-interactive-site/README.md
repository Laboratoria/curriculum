...
curso que se toma como parte del bootcamp y consiste de material que todo
profesional del mundo digital debe saber.
...
El propósito de este curso es que tengas un conocimiento práctico de lo que
significa crear un producto web interactivo. Al terminar este curso sabrás
del rubro y podrás decidir en qué especializarte. Podrás optar por seguir el
camino de convertirte en una `ux designer` o en una `front-end developer`.

## Aprenderás:

* Cómo funciona la Web: `html`, `css`, `js`, `http` & `urls`
