...
`,
  ...
  <p>
    ...
    dados com Firestore</strong> e <strong>encaminhamento (rotas) de páginas ou componentes
    </strong>, introduzindo o conceito de <strong>SPA (Single Page
    Application)</strong>.
  </p>
  <p>
...
`,
  ...
  <p>
    ...
    frontend usando <strong>frameworks como React, Angular ou Vue</strong>, assim
    como projetos que saem do escopo do próprio frontend, fazendo
...
`,
  ...
  <p>
    ...
    sair a buscar emprego como desenvolvedora. Este projeto está listado no final,
    mas isso não significa que é iniciado após ser completado os
...
`,
  ...
  <p>
    Os primeiros projetos da trilha de aprendizado são introdutórios ao design de experiência do usuário. E os seguintes projetos são mais aplicados nos quais as alunas poderão trabalhar com desafios reais de empresas. A escolha dos desafios para trabalhar dependerá das <strong>necessidades e interesses de cada aluna</strong>. Isso significa que nos projetos que envolvam empresas, elas poderão escolher com qual empresa e equipe trabalhar. Espera-se que isso seja concluído por pelo menos um projeto de cada um dos níveis 0 a 4, tendo-se cumprido com a maioria dos objetivos de aprendizagem correspondentes.
  </p>
`,
  'projects.ux.level.0': `
  <p>
  É a primeira abordagem das estudantes ao Design Centrado no Humano. Se dá durante o processo de admissão.
  </p>
`,
  'projects.ux.level.1': `
  <p>
...
`,
  'projects.ux.level.2': `
  <p>
  É o primeiro desafio em que se trabalha com um cliente real. Além dos conceitos básicos de UX Design, as alunas devem aprender a entender o negócio, se comunicar e negociar com os clientes. E definir o escopo de seus projetos.
  </p>
`,
  'projects.ux.level.3': `
  <p>
  É um desafio focado em fortalecer as habilidades de UI Design. A ideia é se
  sentir mais confortáveis criando interfaces e trabalhando com conceitos próprios
  neste campo: <strong>alinhamentos</strong>, <strong>hierarquias</strong>,
  <strong>estilos</strong>, <strong>guias de componentes</strong>,
  <strong>design responsivo</strong>, <strong>variantes</strong>,
  <strong>autolayout</strong>, entre otros.
  </p>
`,
  'projects.ux.level.4': `
  <p>
  Durante estes desafios as estudantes colocarão em práctica tudo o que aprenderam
  durante o bootcamp para realizar uma consultoria em UX a diferentes empresas
  da indústria. Estes desafios incluem temas como
