...
La propiedad `value` establece o devuelve el valor del atributo value de un elemento html, siempre y cuando en dicho elemento exista la propiedad value, algunas de las etiquetas que contienen la propiedad `value` son elementos de formularios.
...
Te recomendamos replicar los ejemplos de código que se han ido mostrando a la largo de la lectura. Además de poner en práctica la teoría con los siguientes vídeos.
