...
describe('getElementOfArrayProperty()', () => {
  it("deve devolver undefined, para ({yey: [1, 3, 5, 7]}, 'key', 1)", () => {
    const obj = {
	 yey: [1, 3, 5, 7],
    };
  ...
  it("deve devolver undefined, para  ({key: 'eyoooo'}, 'key', 1)", () => {
    const obj = {
	 key: 'eyoooo',
    };
  ...
  it("deve devolver undefined, para ({key: ['Kemal', 'Mahmud']}, 'key', 2)", () => {
    const obj = {
	 key: ['Kemal', 'Mahmud'],
    };
  ...
  it("deve devolver 3, para ({key: [1, 2, 3, 4, 5]}, 'key', 2)", () => {
    const obj = {
	 key: [1, 2, 3, 4, 5],
    };
    const output = getElementOfArrayProperty(obj, 'key', 2);
