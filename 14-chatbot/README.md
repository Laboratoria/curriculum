...
Este curso está destinado a personas con conocimientos en C# o Node.js y que deseen comenzar a desarrollar bots multi-plataforma utilizando Bot Framework.    

## Requerimientos previos

* [Visual Studio](https://www.visualstudio.com/es/downloads/)(la versión de la comunidad está bien) (podría usar [Visual Studio Code](https://www.visualstudio.com/es/downloads/) en sistemas que no son de Windows.
* Una cuenta de Microsoft para iniciar sesión en el portal de desarrolladores de Framework Bot, que utilizará para registrar su Bot así como para suscribirse a las suscripciones de Servicios Cognitivos (si tiene Hotmail, Live, Outlook.com, entonces ya tiene una cuenta de Microsoft).
* El simulador de framework de Bot de la página de [descargas](https://github.com/Microsoft/BotFramework-Emulator/releases/tag/v3.5.34) de Framework de Bot.
* La Plantilla de Visual Framework de Visual Studio (C#) de la página de [Descargas](http://aka.ms/bf-bc-vstemplate) de Framework de Bot.
...
* [Constructores](https://docs.microsoft.com/es-es/dotnet/csharp/programming-guide/classes-and-structs/using-constructors)
* [Interfaces](https://docs.microsoft.com/es-es/dotnet/csharp/programming-guide/interfaces/index)
* [Herencia](https://docs.microsoft.com/es-es/dotnet/csharp/programming-guide/classes-and-structs/inheritance)
* [Eventos](https://docs.microsoft.com/es-es/dotnet/csharp/programming-guide/events/how-to-subscribe-to-and-unsubscribe-from-events)
* [Delegate](https://docs.microsoft.com/es-es/dotnet/csharp/programming-guide/delegates/index)
* [Linq](https://docs.microsoft.com/es-es/dotnet/csharp/linq/index)
* [Expresiones lambda](https://docs.microsoft.com/es-es/dotnet/csharp/programming-guide/statements-expressions-operators/lambda-expressions)
* [Las directivas de compilación](https://docs.microsoft.com/es-es/dotnet/csharp/language-reference/preprocessor-directives/preprocessor-if) (comenzando con #if)
* [Conversiones de datos](https://docs.microsoft.com/es-es/dotnet/csharp/programming-guide/types/casting-and-type-conversions)
* [El manejo de excepciones Genérico](https://docs.microsoft.com/es-es/dotnet/csharp/programming-guide/exceptions/index)
* [Async y Await](https://docs.microsoft.com/es-es/dotnet/csharp/language-reference/keywords/async)

Los temas son sólo una recomendación, no es obligatorio conocer a todos

## Aprenderás

Al finalizar este entrenamiento, habremos presentado al participante:
...
* Fundamentos para crear sus propios bots conectados a los servicios en la nube de Microsoft Azure.
...
* [Muestras de Bot para C# Link](https://github.com/Microsoft/BotBuilder/tree/master/CSharp/Samples)
